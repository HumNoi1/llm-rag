                      ...
                      {uploadedQuestions.map((question) => (
                        <tr key={question.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${question.status === 'evaluated' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'
                              }`}>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {evaluatedAnswers.map((answer) => (
                        <tr key={answer.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${(answer.score / 40) >= 0.8 ? 'bg-green-100 text-green-800' :
                        ...
                        <tr key={student.id} className={`hover:bg-gray-50 ${editModeStudent === student.id ? 'bg-blue-50' : ''}`}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            {editModeStudent === student.id ? (
                              ...
                              <div className="flex items-center space-x-2">
                                <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${(student.score / 40) >= 0.8 ? 'bg-green-100 text-green-800' :
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-center">
                            <button
                              ...
                              className={`p-2 rounded-full focus:outline-none transition-colors ${editModeStudent === student.id ? 'bg-gray-200 text-gray-400 cursor-not-allowed' :
                ...
                <div className="mt-4 flex justify-end">
                  <button
                    onClick={() => {
                      ...
                      // สร้าง Blob พร้อม UTF-8 BOM เพื่อให้ Excel อ่านภาษาไทยได้ถูกต้อง
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <div className="flex items-center">
                  <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${classInfo?.is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
                    }`}>
